...
#define LOG_PATH                                                                                                       \
  QString("AppData%1LocalLow%2Wizards of the Coast%3MTGA")                                                             \
      .arg(QDir::separator())                                                                                          \
      .arg(QDir::separator())                                                                                          \
      .arg(QDir::separator())
...
UserSettings AppSettings::getUserSettings()
{
  ...
  UserSettings userSettings =
      UserSettings(json["id"].toString(""), json["email"].toString(""), json["token"].toString(""),
                   json["refresh_token"].toString(""), json["expires_epoch"].toDouble(0));
