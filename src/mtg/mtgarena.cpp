...
MtgArena::MtgArena(QObject* parent) : QObject(parent), isFocused(false), isRunning(false)
{
  ...
  connect(this, &MtgArena::sgnMTGAStarted, this, &MtgArena::onMtgaStarted);
  connect(this, &MtgArena::sgnMTGAStopped, this, &MtgArena::onMtgaStopped);
  connect(this, &MtgArena::sgnMTGAFocusChanged, this, &MtgArena::onMtgaFocusChanged);
