...
MtgaLogWatcher::MtgaLogWatcher(QObject* parent)
  : QObject(parent), logFile(nullptr), timer(new QTimer(this)), lastFilePos(0)
{
  ...
  {
    connect(mtgArena, &MtgArena::sgnMTGAFocusChanged, this, &MtgaLogWatcher::onGameFocusChanged);
    connect(mtgArena, &MtgArena::sgnMTGAStarted, this, &MtgaLogWatcher::startWatching);
    connect(mtgArena, &MtgArena::sgnMTGAStopped, this, &MtgaLogWatcher::stopWatching);
  }
