...
signals:
  ...
  void sgnPlayerDeckWithSideboardSubmited(QMap<Card*, int> mainDeck, QMap<Card*, int> sideboard);
  ...
  void sgnEventFinish(QString eventId, QString deckId, QString deckColors, int maxWins, int wins, int losses);
  void sgnDraftPick(int mtgaId, int packNumber, int pickNumber);
  void sgnDraftStatus(QString eventId, QString status, int packNumber, int pickNumber, QList<Card*> availablePicks,
