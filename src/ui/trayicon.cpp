...
void TrayIcon::configTestMenu(QMenu* testMenu)
{
  ...
  connect(loadDeckAction, &QAction::triggered, this, [this]() {
    ...
    emit mtgaLogParser->sgnMatchCreated(QString("ConstructedRanked1"), OpponentInfo("", "Beginner", 0));
    // Player Select Deck
    QString applicationDir = QCoreApplication::applicationDirPath();
#if defined Q_OS_MAC
    applicationDir = applicationDir.replace("/Contents/MacOS", "");
    applicationDir = applicationDir.left(applicationDir.lastIndexOf("/"));
#endif
  ...
  connect(deckOverlayDraftAction, &QAction::triggered, this, []() {
    QList<int> cardsMtgaId = { 66997, 66717, 66867, 66893, 66827, 66895, 66631,
                               66663, 66747, 66999, 66811, 67007, 66787, 66921 };
