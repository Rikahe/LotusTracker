...
public:
  ...
  QString name()
  {
    QMap<ZoneType, QString> zoneTypeNames = { { ZoneType_HAND, "Hand" },
  ...
  {
    QMap<QString, ZoneType> zoneTypeNames = { { "ZoneType_Hand", ZoneType_HAND },
                                              { "ZoneType_Library", ZoneType_LIBRARY },
                                              { "ZoneType_Graveyard", ZoneType_GRAVEYARD },
                                              { "ZoneType_Exile", ZoneType_EXILE },
                                              { "ZoneType_Limbo", ZoneType_LIMBO },
                                              { "ZoneType_Stack", ZoneType_STACK },
