...
public:
  ...
  Card(int mtgaId = 0, int multiverseId = 0, QString setCode = "", QString number = "", QString rarity = "",
       QString name = "", QString type = "", QString layout = "", int cmc = 0, QString rawManaCost = "",
       QList<QString> manaSymbols = {}, QList<QChar> borderColors = {}, QList<QChar> colorIdentity = {},
       QString imageUrl = "", QString lvsRank = "", QString lvsDesc = "", bool isLand = false, bool isArtifact = false)
    : mtgaId(mtgaId)
  ...
  int manaCostValue()
  {
    ...
    {
      manaValue += mana[0].isDigit() ? mana.toInt() : magicColors.contains(mana) ? 1 : 0;
    }
    return manaValue;
  }
