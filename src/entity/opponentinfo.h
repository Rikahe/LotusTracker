...
public:
  OpponentInfo(QString opponentName = "", QString opponentRankClass = "", int opponentRankTier = 0)
    : _opponentName(opponentName), _opponentRankClass(opponentRankClass), _opponentRankTier(opponentRankTier)
  {
  }
  ...
  QString opponentRankClass()
  {
    return _opponentRankClass;
  }
  int opponentRankTier()
  {
    return _opponentRankTier;
  }
};
