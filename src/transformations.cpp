...
QString Transformations::colorIdentityListToString(const QList<QChar>& distinctManaSymbols)
{
  ...
  if (distinctManaSymbols.contains(QChar('c')))
  {
    return "c";
  }
  ...
  QString identity = "";
  if (distinctManaSymbols.contains(QChar('b')))
  {
    identity += "b";
  }
  if (distinctManaSymbols.contains(QChar('g')))
  {
    identity += "g";
  }
  if (distinctManaSymbols.contains(QChar('r')))
  {
    identity += "r";
  }
  if (distinctManaSymbols.contains(QChar('u')))
  {
    identity += "u";
  }
  if (distinctManaSymbols.contains(QChar('w')))
  {
    identity += "w";
  }
  if (identity == "bg")
