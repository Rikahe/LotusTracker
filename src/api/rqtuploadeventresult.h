...
public:
  ...
  RqtUploadEventResult(QString eventId, QString deckId, QString deckColors, int maxWins, int wins, int losses)
  {
    QJsonObject jsonObj{ { "deckId", deckId },   { "deckColors", deckColors },
                         { "eventId", eventId }, { "maxWins", maxWins },
