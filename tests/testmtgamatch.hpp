...
public:
  TestMtgaMatch()
  {
    ...
    connect(mtgaLogParser, &MtgaLogParser::sgnMatchCreated, mtgaMatch, &MtgaMatch::onStartNewMatch);
    connect(mtgaLogParser, &MtgaLogParser::sgnMatchInfoSeats, mtgaMatch, &MtgaMatch::onMatchInfoSeats);
    connect(mtgaLogParser, &MtgaLogParser::sgnMatchResult, mtgaMatch, &MtgaMatch::onEndCurrentMatch);
    connect(mtgaLogParser, &MtgaLogParser::sgnGameStart, mtgaMatch, &MtgaMatch::onGameStart);
    connect(mtgaLogParser, &MtgaLogParser::sgnMatchStateDiff, mtgaMatch, &MtgaMatch::onMatchStateDiff);
    connect(mtgaLogParser, &MtgaLogParser::sgnNewTurnStarted, mtgaMatch, &MtgaMatch::onNewTurnStarted);
  }
